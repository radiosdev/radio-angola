    ...
    >
      <div className="wrapper bg-[#081730] flex items-center justify-between px-[5rem] rounded-b-[5rem] w-[100%] h-[35rem] relative z-[3]">
        ...
        <div className="headings flex flex-col items-start justify-center h-[100%] text-[3rem]">
          <span>Experimente a</span>{" "}
          <span>
            <b>Melhor Radio de qualidade</b>
          </span>
          <span className="text-[15px] text-[#525D6E]">
          Preencha o seu mundo com as músicas, álbuns e progamas de que mais gosta.
            <br />
            e fique por dentro das notícias do setor.
          </span>
          {/* download ads */}
          <div>
            <span className="text-[13px]">Baixe agora no IOS e Android</span>
            <DownloadAds />
          </div>
        </div>
        {/* right side */}
