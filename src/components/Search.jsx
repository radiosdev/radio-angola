    ...
    <div className="search relative h-[65rem] px-[5rem] bg-[#081730] pt-[18rem] pb-[10rem] mt-[-15rem] z-[1] flex items-center justify-between rounded-b-[5rem]">
      ...
      <div className="right flex items-start flex-col justify-start flex-1 h-[100%] pt-[9rem]">
        ...
        <div className="searchbar flex justify-start w-[100%]">
          <input
            type="text"
            placeholder="Insira a palavra-chave ou Estação"
        ...
        <div className="detail flex flex-col mt-5 text-4xl">
          <span>Pesquisar Progamas por</span>
          <span>
            <b>Nome ou por palavras Chaves</b>
          </span>
          <span className="text-sm mt-3 text-[#4D586A]">
          Radio Tunga Né é o primeiro aplicativo que combina os benefícios múltiplos
           <br />
           de rádio on-line com a simplicidade  <br /> dos sintonizadores de rádio de outrora.
